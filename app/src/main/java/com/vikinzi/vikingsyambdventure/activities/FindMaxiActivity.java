...
public class FindMaxiActivity extends AppCompatActivity {
    ...
    DatabaseReference mMatchmaker = database.getReference("maximatchmaker");
    DatabaseReference mGamesReference = database.getReference("maxigames");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_find_maxi);
                    ...
                    dbReference.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            if(dataSnapshot.getChildrenCount()==2){
                                ...
                                Intent startGame = new Intent(FindMaxiActivity.this, MaxiYamb.class);
