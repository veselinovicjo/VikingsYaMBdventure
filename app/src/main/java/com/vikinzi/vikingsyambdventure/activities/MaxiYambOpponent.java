...
public class MaxiYambOpponent extends AppCompatActivity implements View.OnClickListener
{
    ...
    DatabaseReference parRef, myRef,oppRef, profileRef ,Tabela;
    Integer[] niz = new Integer[78];
    String opponentID = "";
    ...
    private void initData(){
        opponentID = getIntent().getStringExtra("opponent");

        auth = FirebaseAuth.getInstance();
        database = FirebaseDatabase.getInstance();
        parRef = database.getReference("users");

        oppRef = parRef.child(opponentID);
        Tabela = oppRef.child("tabelamaxi");
    ...
    public void populateTable(Integer[] tabel){
        ...
        center_1.setText(String.valueOf(niz[52]));
        center_2.setText(String.valueOf(niz[53]));
        center_3.setText(String.valueOf(niz[54]));
        center_4.setText(String.valueOf(niz[55]));
        center_5.setText(String.valueOf(niz[56]));
        center_6.setText(String.valueOf(niz[57]));
        center_max.setText(String.valueOf(niz[58]));
        center_min.setText(String.valueOf(niz[59]));
        center_straight.setText(String.valueOf(niz[60]));
        center_three.setText(String.valueOf(niz[61]));
        center_full.setText(String.valueOf(niz[62]));
        center_poker.setText(String.valueOf(niz[63]));
        center_yamb.setText(String.valueOf(niz[64]));

        sides_1.setText(String.valueOf(niz[65]));
        sides_2.setText(String.valueOf(niz[66]));
        sides_3.setText(String.valueOf(niz[67]));
        sides_4.setText(String.valueOf(niz[68]));
        sides_5.setText(String.valueOf(niz[69]));
        sides_6.setText(String.valueOf(niz[70]));
        sides_max.setText(String.valueOf(niz[71]));
        sides_min.setText(String.valueOf(niz[72]));
        sides_straight.setText(String.valueOf(niz[73]));
        sides_three.setText(String.valueOf(niz[74]));
        sides_full.setText(String.valueOf(niz[75]));
        sides_poker.setText(String.valueOf(niz[76]));
        sides_yamb.setText(String.valueOf(niz[77]));
    ...
    public int MaxMinSum(){
        ...
        if (niz[59] != -1 && niz[52] != -1)
            sum5 = (niz[58] - niz[59]) * niz[52];
        if (niz[71] != -1 && niz[72] != -1)
            sum6 = (niz[71] - niz[72]) * niz[65];
        sum = sum1+sum2+sum3+sum4+sum5+sum6;
        if(sum1 != 0)
