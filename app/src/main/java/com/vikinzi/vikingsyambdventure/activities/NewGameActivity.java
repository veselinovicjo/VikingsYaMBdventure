...
public class NewGameActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        txt_multi  = (TextView) findViewById(R.id.txt_multi);
        txt_multi.setTypeface(enchantedLandFont);
...
//        //Card view verzija - opens only in first entering the game
        ...
        mini.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent goToMini = new Intent(NewGameActivity.this, FindMiniActivity.class);
        ...
        maxi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent goToMaxi = new Intent(NewGameActivity.this, FindMaxiActivity.class);
...
//        showPopup();
    ...
    //Popup verzija za Help
//    public void showPopup()
//    {
//        popupDialog.setContentView(R.layout.popup_newgame);
