...
//    Down Down;
    ...
    private DatabaseReference parRef, myRef, oppRef, coinsRef, profileRef, Tabela;
    ...
    private void initData() {
        ...
        for (int i = 0; i < 78; i++)
            arrayCeo[i] = -1;
        Tabela.setValue(Arrays.asList(arrayCeo));
        ...
        if (keyCode == KeyEvent.KEYCODE_BACK)
        {
            ...
            btn_yes.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent i;
                    i = new Intent(MaxiYamb.this, NewGameActivity.class);
                    startActivity(i);
                    finish();
                }
            });
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.profile:
                Intent gooToOpp = new Intent(MaxiYamb.this, MaxiYambOpponent.class);
                gooToOpp.putExtra("opponent", opponentUID);
                startActivity(gooToOpp);
                break;
        }
    }
    @Override
